...
cp ~/.config/awesome/rc.lua ~/note/freeBSD/config/awesome/rc.lua
cp ~/.xinitrc ~/note/freeBSD/config/shell/.xinitrc
cp ~/.Xresources ~/note/freeBSD/config/shell/.Xresources
